...
public class ServicesManager {
			 ...
			 String state, String categoryID, String tags)
	{
		...
		try
		{
			...
			String desc = URLEncoder.encode(Description, "ISO-8859-1");
			String Uri = URLEncoder.encode(URI, "UTF-8");
			String sName = URLEncoder.encode(shortName,"UTF-8");
			String tgs = URLEncoder.encode(tags,"UTF-8");
			String url = this.URL + "service/" + upUser + "/" + name + "/"  + Active + "/" + state + "/" + categoryID + "/" + sName + "?description="+desc +"&URI="+Uri+"&tags="+tgs;
			RESTclient client = new RESTclient (url);
	...
	public String updateService (String id, String name, String shortName,
		...
		try{
			...
			String url = this.URL + "service/" + id + "?name=" + nm + "&category="  + type + "&desc="+des + "&URI="+Uri+"&tags="+tgs;
