...
String title = (request.getParameter("title") != null) ? request.getParameter("title") : "Process success!!";
String msg = (request.getParameter("msg") != null) ? request.getParameter("msg") : "The proccess has finished successfully";
...
<head>
<title>DICODE Workbench - Confirmation</title>
